...
var event_text = [
                ...
                //  'You step on kryptonite thorns!',
                 ...
                 //   'You encounter a pillow of dandellions. Soft and silky, you feel a bit drowsy. Wanna take a short nap?',
                //      'You almost slipped on mud! Walk slowly.',
                //   'You encounter a well. It looks deep. What\'s in there, Timmie? Do you wanna find out?',
                //   'Thump Thump Thump. Fee Fi Fo Thumb. Good thing BIG didn\'t step on you!',
...
$(".story_button").click(function(e) {
    ...
    if (event_options[nextactionSelect] == 'sure') {
        ...
        $('.button_ok').show();
        $('.actions').hide();
    } else if (event_options[nextactionSelect] == 'mom_found'){
        $('.story_button').hide();
        $('.actions').hide();
